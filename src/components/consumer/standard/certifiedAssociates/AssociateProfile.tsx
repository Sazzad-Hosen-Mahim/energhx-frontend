  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h2 className="text-gray-700 font-medium text-lg">
        Certified Associates <span className="text-black font-semibold">→ Emmanuel Nonye</span>
      </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[3fr_1fr] gap-8 mt-6">
        ...
        <div className="bg-gray-100 p-6 rounded-xl shadow-md">
          ...
          <div className="mt-6 border-t pt-4">
            <h4 className="text-gray-700 font-semibold text-sm">Contact Info</h4>
          ...
          {/* Certificates */}
          <div className="mt-6 border-t pt-4">
            <h4 className="text-gray-700 font-semibold text-sm">Certificates</h4>
            <p className="text-gray-600 text-sm mt-2 flex items-center">
              🏅 <span className="ml-2 text-red-500 font-medium">Developer Certificate 2024</span>
            </p>
            <p className="text-gray-500 text-xs ml-6">Here is the current Location Lorem Ipsum used since 1200</p>

            <p className="text-gray-600 text-sm mt-2 flex items-center">
              🏅 <span className="ml-2 text-green-500 font-medium">Server Certificate 2023</span>
            </p>
          </div>
        </div>
      </div>
