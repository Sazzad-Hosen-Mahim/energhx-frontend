...
const AppointmentRequest = () => {
  ...
  return (
    <div>
      {/* Ensure RequestList works by passing props if needed */}
      <RequestList appointments={appointments} />
      ...
      <div className="p-6 min-h-screen">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          <div className="p-6 bg-green-600 shadow-md text-white rounded-lg text-center text-2xl font-md h-[175px] flex flex-col items-center justify-center gap-2">
            04
            <br />
            <span className="text-lg border-t-1 pt-2">Recent Appointment List</span>
          </div>
          <div className="p-6 bg-[#EAF7E6] shadow-md text-green-800 rounded-lg text-center text-2xl font-md h-[175px] flex flex-col items-center justify-center gap-2">
            02
            <br />
            <span className="text-lg border-t-1 pt-2">Running Appointment List</span>
          </div>
          <div className="p-6 bg-[#EAF7E6] shadow-md text-green-800 rounded-lg text-center text-2xl font-md h-[175px] flex flex-col items-center justify-center gap-2">
            33
            <br />
            <span className="text-lg border-t-1 pt-2">Completed Appointment List</span>
          </div>
        </div>
