      ...
      <div className="bg-white rounded-xl p-8 max-w-2xl  flex flex-col gap-4 text-[#394A3F]">
        ...
        <div className="flex   items-start gap-1">
          ...
          <p>
            ...
            standard delivery charges, delivery charges, gas supply and
            transportation charges to your utility every month.{" "}
            <span className="text-primary cursor-pointer">more details</span>
          </p>
        </div>
